          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link 
                to="/planos" 
                id="hero-planos-btn"
                className="px-6 py-3 border border-primary-600 text-primary-600 font-medium rounded-md hover:bg-primary-50 transition text-center"
              >
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              to="/planos" 
              id="cta-planos-btn"
              className="px-6 py-3 border border-white text-white font-medium rounded-md hover:bg-primary-700 transition text-center"
            >
              Conheça nossos planos
            </Link>
          </div>
