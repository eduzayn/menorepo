 ...
 */
export async function getPublishedPages(client) {
    // Retornar dados mockados se estiver no modo de teste
    if (USE_MOCK_DATA) {
 ...
 * @returns Lista de páginas ou erro
 */
export async function getAllPages(client) {
    // Retornar dados mockados se estiver no modo de teste
    if (USE_MOCK_DATA) {
        return {
            pages: mockPages,
 ...
 */
export async function createPage(client, data) {
 ...
 */
export async function updatePage(client, id, data) {
 ...
 * @returns Sucesso ou erro
 */
export async function deletePage(client, id) {
