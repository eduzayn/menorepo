 ...
 */
export function usePublishedBlogPosts(options: { limit?: number; page?: number; categoryId?: string } = {}) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { posts, total, error } = await BlogService.getPublishedBlogPosts(
        client, 
        limit, 
        offset, 
        categoryId
...
export function useCreateBlogPost() {
  ...
  return useMutation({
    mutationFn: async (data: BlogService.BlogPostInput) => {
...
export function useUpdateBlogPost() {
  ...
  return useMutation({
    mutationFn: async ({ id, data }: { id: string; data: Partial<BlogService.BlogPostInput> }) => {
...
export function useCreateBlogCategory() {
  ...
  return useMutation({
    mutationFn: async (data: BlogService.BlogCategoryInput) => {
 ...
 */
export function useBlogAuthorById(id: string) {
  const { client } = useApi();
...
export function useCreateBlogAuthor() {
  ...
  return useMutation({
    mutationFn: async (data: BlogService.BlogAuthorInput) => {
