          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-primary-800 mb-2">Telefone</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-primary-800 mb-2">E-mail</h3>
                <p className="text-gray-700">contato@edunexia.com</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-xl font-semibold text-primary-800 mb-2">Endereço</h3>
