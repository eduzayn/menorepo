      ...
      <section className="py-16 bg-primary-50">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <p className="text-gray-700 mb-8">
            Receba conteúdos exclusivos, tendências do setor educacional e novidades sobre tecnologia diretamente em seu email.
          </p>
          <form className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-primary-600 text-white font-medium rounded-md shadow-md hover:bg-primary-700 transition-colors"
            >
              Inscrever-se
            </button>
          </form>
